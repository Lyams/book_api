...
UPD.:Заменил простую какбы валиацию email валидацией с помощью valid_email2. Добавил в CI линтер - Rubocop и утилиты для анализа безопастности - brakeman и bundle-audit.
